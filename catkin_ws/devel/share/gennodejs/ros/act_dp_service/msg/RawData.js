...
class RawData {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('depth_data')) {
        ...
        this.depth_data = new std_msgs.msg.UInt8MultiArray();
      }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = std_msgs.msg.UInt8MultiArray.serialize(obj.depth_data, buffer, bufferOffset);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    data.depth_data = std_msgs.msg.UInt8MultiArray.deserialize(buffer, bufferOffset);
  ...
  static getMessageSize(object) {
    ...
    length += std_msgs.msg.UInt8MultiArray.getMessageSize(object.depth_data);
    return length + 9;
  }
  ...
  static md5sum() {
    ...
    return '2028a2619c88661ed127cab0fd5a32f5';
  }
  ...
  static Resolve(msg) {
    ...
    if (msg.depth_data !== undefined) {
      resolved.depth_data = std_msgs.msg.UInt8MultiArray.Resolve(msg.depth_data)
    }
    else {
      resolved.depth_data = new std_msgs.msg.UInt8MultiArray()
    }
