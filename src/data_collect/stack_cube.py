...
class StackCubeDataCollect(BaseDataCollect):
    ...
    def __init__(self,*args,**kwargs):
        ...
        trajectory = [
            ...
            {"t": 60, "xyz": [pos_red[0], pos_red[1], pos_red[2] - 0.02], "quat": gripper_quat, "gripper": 1.0},  # 下沉
            {"t": 68, "xyz": [pos_red[0], pos_red[1], pos_red[2] - 0.02], "quat": gripper_quat, "gripper": 0.1},  # 抓取
